        ...
        public async Task ManageTicketNotifications(Ticket oldTicket, Ticket newTicket)
        {
            ...
            if (oldTicket.DeveloperId != newTicket.DeveloperId && !string.IsNullOrEmpty(newTicket.DeveloperId))
            {
                ...
                var notification = new TicketNotification()
                {
                    ...
                    Message = $"{newTicket.Developer.FirstName} has been assigned to Ticket Id {newTicket.Id},'{newTicket.Issue}' on Project '{newTicket.Project.Name}.'"
                };
            ...
            if ((oldTicket.DeveloperId != newTicket.DeveloperId) && !string.IsNullOrEmpty(oldTicket.DeveloperId))
            {
                ...
                var notification = new TicketNotification()
                {
                    ...
                    Message = $"{oldTicket.Developer.FirstName} has been un-assigned from Ticket Id {oldTicket.Id},'{newTicket.Issue}.'"
                };
